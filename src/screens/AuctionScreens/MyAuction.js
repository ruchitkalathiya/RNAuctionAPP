...
import {FlatList, StyleSheet,TouchableOpacity,Image,View,ActivityIndicator,Text,Dimensions,Alert,Button} from 'react-native';
...
const MyAuction=({navigation})=>{
  ...
  const fetchDetails = async (value2) => {
    ...
    Axios.post("http://192.168.1.104:5000/api/BidProduct/MyAuctionlistAllFiles", {
        userid:value2
      })
